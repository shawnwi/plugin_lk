			...
			init : function( options ) {
				...
				var mdp_events = {
					...
					beforeShowDay : function(date) {
						...
						bsdReturn[1] = gotThisDate ? 'ui-state-highlight '+ bsdReturn[1] + classname_new : bsdReturn[1] + classname_new;
						//bsdReturn[0] = bsdReturn[0] && !(isDisabledCalendar || isDisabledDate || (areAllSelected && !bsdReturn[1] + classname_new));
